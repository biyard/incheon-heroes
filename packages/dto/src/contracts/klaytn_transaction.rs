...
#[cfg(feature = "server")]
impl schemars::JsonSchema for KlaytnTransaction {
...
#[cfg(feature = "server")]
impl by_axum::aide::OperationInput for KlaytnTransaction {}

#[cfg(feature = "server")]
impl by_axum::aide::OperationOutput for KlaytnTransaction {
    type Inner = Self;
}
...
mod tests {
    ...
    fn test_rlp_fd_contract_execution() {
        ...
        assert_eq!(hex::encode(rlp).as_str(),
