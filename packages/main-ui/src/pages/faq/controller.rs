    ...
    pub fn new(lang: Language) -> std::result::Result<Self, RenderError> {
        let faqs = use_server_future(move || async move {
            if lang == Language::Ko {
                vec![
                    Faq {
                        question: "인천히어로즈는 무슨 프로젝트인가요?".to_string(),
                    ...
                    Faq {
                        ...
                        answer: "인천히어로즈의 중심이 되는 Membership NFT 입니다. 인천시의 대표 캐릭터인 점박이 물범을 작품화하여 인천을 사랑하고 인천의 도시가치에 공감하는 사람들을 소유자로 초대합니다. 멸종위기종인 점박이 물범들이 슈퍼히어로가 되어 지구와 바다의 환경을 지키고 기후변화에 동참하는 시민들과 함께하는 스토리를 담고 있습니다.".to_string(),
                    },
                    Faq {
                        question: "인천히어로즈의 NFT는 어떻게 거래할 수 있나요?".to_string(),
                        answer: "인천히어로즈 디스코드에서 확인해 보세요 :)".to_string(),
                    },
                    Faq {
                        question: "인천히어로즈의 멤버가 되면 어떤 혜택이 있나요?".to_string(),
                    ...
                    Faq {
                        ...
                        answer: "인천히어로즈 커뮤니티, SNS를 통해 프로젝트의 다양한 정보를 확인할 수 있어요! 자세한 정보는 인천히어로즈 웹페이지에서도 확인 가능합니다:)".to_string(),
                    },
                    Faq {
                ...
                vec![
                    Faq {
                        question: "What kind of project is Incheon Heroes?".to_string(),
                    ...
                    Faq {
                        ...
                        answer: "IncheonHeroes NFT is core of Membership. It invites people who love Incheon and resonate with the city's values by transforming Incheon's representative character, Spotty Seal, into artwork. This NFT project features endangered Spotty Seals turning into superheroes, joining citizens in protecting the environment and combating climate change on Earth and in the oceans.".to_string(),
                    },
                    Faq {
                        question: "How can I trade Incheon Universe NFT?".to_string(),
                        answer: "Check it out on Incheon Heroes Discord :)".to_string(),
                    },
                    Faq {
                        question: "What benefits do I get from becoming a member of Incheon Heroes?".to_string(),
                    ...
                    Faq {
                        ...
                        answer: "You can check various information about the project through the Incheon Heroes Community and SNS! For more information, you can also check the Incheon Heroes website. :)".to_string(),
                    },
                    Faq {
